  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "L'assurance tous risques (CDW) est optionnelle mais fortement recommandée. Elle vous protège contre les dommages au véhicule loué (accident, vandalisme), le vol du véhicule et le bris de glace. Prix : environ 80-300 DH/jour selon le véhicule."
        }
      },
      {
        "@type": "Question",
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="insurance-2">
                      ...
                      <AccordionContent className="text-muted-foreground">
                        ...
                        Prix : environ 80-300 DH/jour selon le véhicule. Cela vous évite de payer des frais importants en cas d&apos;incident.
                      </AccordionContent>
                    </AccordionItem>
