  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Découvrez tous nos services de location : aéroports, jeune conducteur, longue durée, SUV 4x4, véhicules de luxe et spéciaux. Tarifs dès 300 DH/jour partout au Maroc." 
        />
        <meta 
          name="keywords" 
        ...
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center text-sm animate-fade-in [animation-delay:400ms]">
              ...
              <div className="flex items-center gap-2">
                <Check className="h-5 w-5 text-primary" />
                <span>Tarifs dès 300 DH/jour</span>
              </div>
            </div>
          </div>
        </div>
