...
const LocationVoitureTanger = () => {
  ...
  useEffect(() => {
    document.title = "Location Voiture Tanger dès 200 DH/jour | Sans Carte de Crédit - Benatna";
    ...
    setMeta('meta[name="description"]', 'content', "Location de voiture à Tanger dès 200 DH/jour. Livraison aéroport Ibn Battouta, port Tanger-Med, sans carte de crédit.", 'name', 'description');
    setMeta('link[rel="canonical"]', 'href', "https://benatna.ma/location-voiture-tanger", 'rel', 'canonical');
    setMeta('meta[property="og:title"]', 'content', "Location Voiture Tanger dès 200 DH/jour | Sans Carte de Crédit - Benatna", 'property', 'og:title');
    setMeta('meta[property="og:description"]', 'content', "Location de voiture à Tanger dès 200 DH/jour. Livraison aéroport Ibn Battouta, port Tanger-Med, sans carte de crédit.", 'property', 'og:description');
