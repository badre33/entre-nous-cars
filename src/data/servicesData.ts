...
export const services: Service[] = [
  ...
  // Longue Durée
  {
    ...
    shortDescription: 'Tarifs mensuels tout compris. Entretien, assurance et assistance inclus. Dès 7 500 DH/mois.',
    features: ['Dès 7 500 DH/mois', 'Entretien inclus', 'Km illimités', 'Résiliable 1 mois préavis'],
    priceFrom: '7 500 DH/mois',
