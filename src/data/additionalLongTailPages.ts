...
const createAeroportPage = (city: string, citySlug: string, airport: string): LongTailPageConfig => {
  ...
  content: {
    intro: `Arrivez à l'${data.fullName} (code IATA ${data.iata}) et récupérez votre voiture de location en quelques minutes avec Benatna. L'aéroport se situe à ${data.distanceFromCenter}, soit ${data.travelTime} en voiture. La livraison gratuite au terminal par le loueur partenaire vous évite les files d'attente des comptoirs aéroportuaires et vous fait économiser jusqu'à 40% par rapport aux tarifs des kiosques. Envoyez votre demande sur WhatsApp avant votre vol — votre véhicule vous attend dès votre atterrissage à ${city}.`,
    sections: [
      {
        title: `L'aéroport ${data.fullName} (${data.iata}) en pratique`,
        content: `Le ${data.fullName} compte ${data.terminals}. ${data.practicalNotes} Pour le stationnement : ${data.parkingInfo}. Si vous récupérez votre véhicule réservé via Benatna, vous évitez totalement la question parking puisque l'agent du loueur vous attend en dépose-minute (P1) avec votre voiture, juste avant les barrières — comptez 5 minutes maximum après votre sortie du hall.`
      },
      {
      ...
      },
      {
        ...
        content: `Lors de votre demande sur WhatsApp, indiquez votre numéro de vol et heure d'arrivée. Le loueur partenaire suit votre vol en temps réel : retard, avance, déroutement — l'heure de rendez-vous s'ajuste automatiquement sans frais. Une fois atterri à ${data.iata}, récupérez vos bagages comme d'habitude. Avant de sortir du hall des arrivées, prévenez le loueur via WhatsApp. Son agent, déjà sur place, vous rejoint en 5-10 minutes au point de rendez-vous. Remise des clés, signature de la carte grise et assistance, paiement (espèces, virement ou carte au choix), petit tour du véhicule — vous êtes en route vers ${city} en 15 minutes maximum après votre sortie du hall.`
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Non, la livraison à l'aéroport par le loueur partenaire est totalement gratuite, contrairement aux comptoirs d'aéroport qui intègrent des frais de concession dans leurs tarifs."
      },
      {
        question: "Que se passe-t-il si mon vol a du retard ?",
        answer: "Le loueur partenaire suit votre vol en temps réel via son numéro. En cas de retard, l'heure de rendez-vous est ajustée automatiquement sans frais supplémentaires. Vous n'avez rien à faire."
      },
      {
        question: `Puis-je réserver une voiture pour une arrivée de nuit à ${data.iata} ?`,
        answer: "Oui, la plupart des loueurs partenaires assurent les arrivées de nuit, selon disponibilité. Que votre vol arrive tard le soir ou tôt le matin, précisez-le dans votre demande WhatsApp et le loueur vous confirme la livraison au terminal."
      },
      {
        question: `Combien de temps entre l'atterrissage et le départ de l'aéroport ${city} ?`,
        answer: `Environ 15 minutes après votre sortie du hall : 5-10 min pour que l'agent du loueur vous rejoigne avec le véhicule, puis 5 min pour la remise des clés, signature des documents et présentation du véhicule. Plus rapide que les files d'attente aux comptoirs classiques (souvent 30-60 min).`
      }
    ]
  },
  cta: {
    title: `Réservez Votre Voiture pour l'Aéroport ${city} (${data.iata})`,
    subtitle: "Livraison gratuite par le loueur • Demande WhatsApp en 2 min • Tarifs transparents",
  ...
  content: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Les loueurs partenaires prévoient toujours une marge de 1h dans leurs forfaits. Au-delà, une heure supplémentaire est facturée selon les conditions du loueur. Et ils trouvent toujours une solution flexible pour ne pas gâcher votre jour J.'
      },
      {
        question: 'La décoration peut-elle être personnalisée à nos couleurs de mariage ?',
        answer: 'Absolument ! Envoyez-nous un échantillon de tissu ou votre palette de couleurs, nous adaptons rubans, nœuds et fleurs. Délai de préparation : 7 jours. Service de décoration personnalisée inclus dans tous les forfaits des loueurs partenaires.'
      }
    ]
  },
  cta: {
    ...
    sections: [
      {
        ...
        content: `Dacia Duster (350 DH/jour) : Le champion du rapport qualité/prix. 4x4 véritable avec modes 2WD/4WD/4WD Lock, garde au sol 21 cm, coffre 445L. Consommation raisonnable 7L/100km diesel. Parfait pour ${region} sans se ruiner. Kilométrage illimité. Nissan Qashqai (420 DH/jour) : Crossover confortable avec transmission intégrale intelligente. Plus urbain que le Duster mais très capable sur pistes sèches. Intérieur premium, GPS écran tactile, caméra recul. Pour ceux qui veulent confort + polyvalence. VW Tiguan (500 DH/jour) : SUV allemand robuste, 4Motion intégrale permanente. Équipement complet : régulateur adaptatif, sièges chauffants, coffre 615L. Moteur diesel 150ch avec couple généreux en montagne. Top pour familles. Toyota Land Cruiser Prado (800 DH/jour) : Le vrai 4x4 baroudeur. Châssis échelle, pont arrière rigide, réducteur. Indestructible, franchissement exceptionnel. Pour Atlas profond, dunes du désert ou expéditions exigeantes. Tous les SUV proposés incluent : GPS Garmin avec cartes Maroc actualisées (POI, pistes, ravitaillements), kit de dépannage (câble remorquage 5T, pelle, planche, gonfleur 12V), assurance pistes et chemins (franchise normale 3000 DH même hors bitume), assistance 4x4 spécialisée (remorquage adapté, partenaires dans tout l\'Atlas). Âge minimum conducteur : 23 ans et 2 ans de permis pour SUV, 25 ans et 3 ans de permis pour Prado (puissance + difficulté technique).`
      },
      {
      ...
      sections: [
        {
          ...
          content: `**Casa-Voyageurs** voit passer plus de **5 millions de voyageurs par an** (chiffre ONCF). C'est le point d'arrivée typique des MRE qui ont combiné ferry Tanger Med + train Al Boraq pour rejoindre Casablanca (3h de Tanger ville à Casa via Al Boraq, vs 3h30 en voiture par autoroute A1 avec péage), des touristes qui ont fait Rabat-Casablanca en TNR rapide (1h, 40 DH), ou des Marocains business qui font Tanger-Casa-Marrakech en train+voiture. La gare est en plein centre Casablanca, **bien plus pratique** que l'aéroport CMN (30 km au sud), et la livraison en gare par le loueur évite la longue queue des taxis bondés à la sortie principale. L'agent du loueur vous reconnaît grâce à votre photo de profil WhatsApp, vous récupère sur le parvis principal (sortie principale boulevard Mohammed V), et vous fait gagner 30 minutes par rapport à l'option taxi + comptoir loueur classique.`
        },
        {
          title: 'Procédure depuis votre train',
          content: `**Avant votre départ** (depuis Tanger Med, Tanger ville, Kenitra, Rabat) : envoyez par WhatsApp votre numéro de train ONCF (TGV Al Boraq Tanger ou TNR Rabat-Casa) et l'heure d'arrivée prévue à Casa-Voyageurs. **À l'arrivée** : descendez du train, suivez les panneaux "Sortie principale boulevard Mohammed V" (vers la rocade). À la sortie, **point de rendez-vous** : kiosque à journaux Sapress côté gauche du parvis, à 30 secondes de la sortie. L'agent du loueur est sur place, repère votre photo, vient à votre rencontre. **Remise des clés** en 5-10 minutes : vérification permis, signature contrat, paiement (espèces DH/€, virement, ou Cash Plus — pas besoin de carte de crédit). Vous êtes dans votre voiture et sur le boulevard Mohammed V (axe principal Casa) en **moins de 15 minutes après votre descente du train**. Comparé à la solution comptoir loueur classique (taxi gare→comptoir loueur 15-30 min + attente comptoir 30-60 min), vous économisez **1h-1h30** sur votre arrivée Casa.`
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Oui, le loueur partenaire suit l\'arrivée temps réel sur le site ONCF Voyages. Son agent attend votre arrivée réelle, pas de frais "retard". Idem si vous arrivez en avance — coordination flexible via WhatsApp.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Service standard 6h-23h, mais service de nuit disponible sur demande (TGV Al Boraq dernier départ Tanger 21h45, arrivée Casa 23h50 ; premier départ Casa 5h25). Pour trains de nuit/aube, un supplément peut s\'appliquer selon les conditions du loueur, car son agent vient en dehors des heures normales.'
        },
        {
          question: 'Y a-t-il un parking à Casa-Voyageurs pour récupérer la voiture ?',
          answer: 'Oui, parking ONCF souterrain accessible directement depuis la gare (entrée P1 sortie sud). L\'agent du loueur peut amener la voiture à n\'importe quel niveau, ou vous rejoindre au parvis principal selon votre confort. Indiquez votre préférence à la réservation.'
        }
      ]
    },
    cta: {
    ...
    content: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: 'Oui, parking ONCF accessible 24/7, 15 DH les premières 2h, 50 DH la journée. L\'agent du loueur peut soit amener la voiture au parking pour remise discrète, soit vous rejoindre au parvis principal — vous choisissez à la réservation.'
        },
        {
    ...
    content: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: 'Oui, **les loueurs partenaires acceptent les permis internationaux** (US, UK, AUS), les permis UE (sans formalité), et les passeports diplomatiques. Conducteur principal doit avoir 25+ ans et 2+ ans de permis. Pour groupes/délégations, le loueur vous propose son meilleur tarif directement sur WhatsApp.'
        }
      ]
    },
    cta: {
    ...
    content: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: '**Non**. Le prix affiché inclut : kilométrage illimité, assurance tous risques de base, assistance 24/7, livraison aéroport ou ville. Les seuls extras possibles : siège bébé (50 DH/jour), GPS (40 DH/jour), conducteur additionnel jeune (-21 ans, 80 DH/jour), conducteur professionnel (400 DH/jour). Carburant en sus selon votre choix (rendre plein, sinon le loueur facture le carburant manquant selon ses conditions).'
        },
        {
          question: 'Acceptez-vous de négocier sur les locations longues ?',
          answer: 'Oui. **Au-delà de 15 jours**, remise dégressive automatique. **Au-delà de 1 mois**, le loueur vous propose son meilleur tarif directement sur WhatsApp. **Pour expatriés longue mission** (3-12 mois), les loueurs partenaires proposent des forfaits mensuels avec remise jusqu\'à 15%, conciergerie automobile incluse selon le loueur (lavage, vidange, contrôle technique pris en charge). Contactez-nous sur WhatsApp pour discuter.'
        },
        {
  ...
  // ============================================================
  {
    ...
    content: {
      ...
      faq: [
        ...
        { question: 'Puis-je louer une boîte automatique sans carte de crédit ?', answer: 'Oui, **toutes les voitures automatiques sont disponibles sans CB internationale**. Paiement : espèces DH ou €, virement SEPA, Cash Plus, Wafacash, carte CMI marocaine. Caution en espèces ou virement.' },
    ...
    relatedServices: [
      { title: 'Location Voiture Automatique Marrakech', description: 'Les voitures automatiques disponibles à Marrakech.', link: '/location-voiture-automatique-marrakech' },
  ...
  // ============================================================
  {
    ...
    content: {
      ...
      sections: [
        ...
        {
          title: 'La flotte automatique de nos loueurs à Marrakech',
    ...
    relatedServices: [
      { title: 'Location Voiture Automatique Casablanca', description: 'Les voitures automatiques disponibles à Casablanca.', link: '/location-voiture-automatique-casablanca' },
...
,
  ...
  // ============================================================
  {
    ...
    content: {
      ...
      faq: [
        { question: 'Comment retirer ma voiture a la sortie du TGV ?', answer: 'Tu nous envoies ton numero de billet et heure arrivee par WhatsApp. L agent du loueur t attend a la sortie principale avec panneau a ton nom. Cles, etat des lieux, et tu pars en 5 minutes.' },
        ...
        { question: 'Que faire si mon train a du retard ?', answer: 'Aucun probleme : l agent du loueur suit ton train via ONCF en temps reel, il est present meme si tu arrives 1-2h en retard. Pas de penalite pour retard TGV.' },
  ...
  // ============================================================
  {
    ...
    relatedServices: [
      { title: 'Location Voiture Marrakech', description: 'Tous les vehicules disponibles a Marrakech.', link: '/location-voiture-marrakech' },
  ...
  },
  {
    ...
    content: {
      ...
      sections: [
        ...
        { title: 'Chauffeur multilingue : francais, anglais, arabe', content: 'Les chauffeurs des agences partenaires parlent **francais** couramment (langue d enseignement Maroc). **Anglais** : 60% le parlent correctement, 30% bien. **Espagnol** : 30% le parlent (Nord du Maroc). **Allemand, italien** : sur demande, chauffeurs specialises disponibles. **Arabe et darija** : maitrise totale evidemment. Pour MRE 3e generation qui ne parle plus arabe : les chauffeurs s adaptent au francais. Pour touriste anglo-saxon : l agence partenaire selectionne un chauffeur anglophone confirme.' }
      ],
      faq: [
