...
export const comparisons: Comparison[] = [
  ...
  // COMPARAISONS CATÉGORIES
  {
    ...
    category: 'categories',
    introduction: 'Catégorie économique ou premium : un choix qui peut doubler votre budget location. Entre Dacia Sandero à 200 DH/jour et Mercedes Classe E à 800 DH/jour, explorons les différences réelles pour vous aider à choisir judicieusement.',
    item1: {
