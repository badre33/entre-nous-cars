...
export const topVehicles: TopVehicle[] = [
  {
    ...
    brand: "Dacia",
    category: "Économique",
    description: "Citadine économique parfaite pour la ville. Consommation réduite, facile à garer, idéale pour 4 personnes. Prix imbattable dès 150 DH/jour.",
  ...
  },
  {
    ...
    brand: "Renault",
    category: "Économique",
    description: "Berline compacte moderne et confortable. Équipement complet, coffre spacieux, parfaite pour couples et petites familles. À partir de 180 DH/jour.",
  ...
  },
  {
    ...
    brand: "Peugeot",
    category: "Économique",
    description: "Citadine élégante et dynamique. Design moderne, technologies embarquées, conduite agréable. Idéale ville et autoroute. 200 DH/jour.",
  ...
  },
  {
    ...
    brand: "Dacia",
    category: "SUV",
    description: "SUV robuste et polyvalent. Garde au sol élevée, coffre immense, parfait pour routes difficiles et familles. Le SUV le plus loué au Maroc. 250 DH/jour.",
  ...
  },
  {
    ...
    description: "SUV urbain élégant et modulable. Confort optimal, technologies modernes, coffre modulable. Parfait compromis ville/voyage. 280 DH/jour.",
  ...
  },
  {
    ...
    brand: "Toyota",
    category: "Berline",
    description: "Berline fiable et spacieuse. Légendaire fiabilité Toyota, confort exceptionnel, économique. Idéale trajets longue distance. 300 DH/jour.",
  ...
  },
  {
    ...
    brand: "Peugeot",
    category: "SUV",
    description: "SUV premium français. Design spectaculaire, i-Cockpit innovant, confort supérieur. SUV familial haut de gamme. 350 DH/jour.",
  ...
  },
  {
    ...
    brand: "Hyundai",
    category: "SUV",
    description: "SUV moderne et spacieux. Technologies avancées, garantie constructeur, sécurité maximale. Parfait familles exigeantes. 320 DH/jour.",
  ...
  },
  {
    ...
    description: "Compacte premium allemande. Qualité de finition supérieure, conduite dynamique, technologies embarquées. La référence du segment. 280 DH/jour.",
  ...
  },
  {
    ...
    brand: "Citroën",
    category: "Économique",
    description: "Citadine confortable et originale. Suspension moelleuse, design personnalisable, équipement complet. Confort Citroën légendaire. 190 DH/jour.",
  ...
  },
  {
    ...
    brand: "Nissan",
    category: "SUV Compact",
    description: "Crossover urbain élégant. Créateur du segment, technologies ProPilot, confort optimal. SUV familial par excellence. 300 DH/jour.",
  ...
  },
  {
    ...
    brand: "Dacia",
    category: "Monospace",
    description: "Monospace 7 places économique. Modulable, coffre immense, prix imbattable. Parfait grandes familles et groupes. Le break familial idéal. 270 DH/jour.",
  ...
  },
  {
    ...
    brand: "Mercedes-Benz",
    category: "Luxe",
    description: "Compacte premium allemande. Luxe Mercedes, système MBUX, finition irréprochable. Prestige accessible. 400 DH/jour.",
  ...
  },
  {
    ...
    brand: "BMW",
    category: "Luxe",
    description: "Berline sportive premium. Plaisir de conduite BMW, technologies iDrive, performances exceptionnelles. La référence du premium sportif. 450 DH/jour.",
  ...
  },
  {
    ...
    brand: "Toyota",
    category: "SUV",
    description: "SUV robuste et fiable. Légendaire fiabilité Toyota, 4x4 véritable, confort et espace. Parfait longues distances et terrains difficiles. 380 DH/jour.",
  ...
  },
  {
    ...
    brand: "Volkswagen",
    category: "Électrique",
    description: "Compacte 100% électrique. Autonomie 420 km, recharge rapide, zéro émission. L'avenir de la mobilité urbaine. 350 DH/jour.",
  ...
  },
  {
    ...
    brand: "Fiat",
    category: "Citadine",
    description: "Citadine italienne iconique. Design rétro chic, maniabilité parfaite, idéale centre-ville. La Dolce Vita à l'italienne. 220 DH/jour.",
  ...
  },
  {
    ...
    brand: "Kia",
    category: "SUV",
    description: "SUV familial moderne. Design audacieux, garantie 7 ans, technologies avancées. Rapport équipement/prix exceptionnel. 310 DH/jour.",
  ...
  },
  {
    ...
    brand: "Ford",
    category: "SUV Compact",
    description: "Crossover sportif et pratique. Coffre MegaBox innovant, conduite dynamique, design moderne. Le SUV urbain sportif. 290 DH/jour.",
  ...
  },
  {
    ...
    brand: "Mazda",
    category: "SUV",
    description: "SUV premium japonais. Design Kodo élégant, finition soignée, conduite plaisir. L'élégance japonaise en SUV. 340 DH/jour.",
